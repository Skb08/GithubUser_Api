...
const Home = () => {
  ...
  return (
    <>
      <div id="carouselExampleFade" className="carousel slide carousel-fade " data-bs-ride="carousel" style={{display:"flex", minHeight:"10rem" }}>
        <div className="carousel-inner" id='carousel'>
          ...
          <div className="carousel-item active">
            <img src="https://source.unsplash.com/random/900x360/?tvshow" className="d-block w-100 h-40" style={{height:"60vh", filter: 'brightness(30%' }} alt="..." />
          </div>
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900x360/?show" className="d-block w-100 h-40" style={{height:"60vh", filter: 'brightness(25%' }} alt="..." />
          </div>
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900x360/?film" className="d-block w-100 h-40" style={{height:"60vh", filter: 'brightness(30%' }} alt="..." />
          </div>
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900x360/?nature" className="d-block w-100 h-40" style={{height:"60vh", filter: 'brightness(30%' }} alt="..." />
          </div>
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900x360/?scenery" className="d-block w-100 h-40" style={{height:"60vh", filter: 'brightness(30%' }} alt="..." />
          </div>
        </div>
      ...
      <div className="" style={{background: "linear-gradient(90deg, rgba(13,129,133,1) 0%, rgba(22,228,174,1) 41%, rgba(18,150,155,1) 100%)" }}>
        <div className="container" style={{padding:0}}>
          ...
          {users.length > 0 && (
            <ul className='row row-cols-1 row-cols-md-2 row-cols-lg-3 g-12' style={{margin:"0",padding:"0"}}>
              {users
